...
export interface ApiDestactadoDestactado extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    destacados: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    columnas: Schema.Attribute.Component<'layout.section-footer', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Enumeration<
      ['hardware', 'notebook', 'perifericos', 'telefonos']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
